        ...
        <div class="row">
          ...
          <section class=" content col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form  method="post" action="{{route('product.store')}}" class="form-horizontal" id="myForm" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <select name="product_name" id="product_id" class="form-control form-control-sm select2" required>
                                          ...
                                          <option value="{{$purchase->id}}">{{$purchase->product_name}}</option>
                                          @endforeach
                                        </select>
                                        <font style="color:#e60000">
