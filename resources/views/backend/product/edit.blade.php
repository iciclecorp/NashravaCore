            ...
            <div class="card">
              <div class="card-header">
                <h3>{{__('back_blade.view_product_edit')}}
                  <a class="btn btn-success btn-sm float-right" href="{{route('product.index')}}"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;{{__('back_blade.view_product_list')}}</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <form  method="post" action="{{route('product.update',$product->id)}}" class="form-horizontal" id="myForm" enctype="multipart/form-data">
                  @csrf
                  @method('PATCH')
                  <div class="row">
                             ...
                             <!--  <div class="form-group new_category col-md-12" style="display:none;">
                              ...
                              <div class="form-group col-md-12">
                                <select name="sub_category_id" id="sub_category" class="form-control-sm form-control" required>
                                    ...
                                    <option value="{{$sub_category->id}}" {{$product->sub_category_id == $sub_category->id ? 'selected' : ''}}>{{$sub_category->sub_category_name}}</option>
                                    @endforeach
                                </select>
                              </div>            
                        </div>
                    ...
                    <div class="card" style="border-top:5px solid #007bff;">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group col-md-4"  id="show">
                          <img id="showImage" src="{{(!empty($product->image))?url($product->image):url('public/upload/image_avatar.jpg')}}" style="width:150px;height:160px;border:1px solid #000;">
                        </div>
                      </div>
                    </div>
                     <div class="card" style="border-top:5px solid #007bff;">
                    ...
                    <!-- form start -->
                          <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="product_name" id="title" class="form-control form-control-sm" value="{{$product->product_name}}" required>
                                        <font style="color:#e60000">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="title" id="title" class="form-control form-control-sm" value="{{$product->title}}" required>
                                         <font style="color:#e60000">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="slug"  class="form-control form-control-sm" value="{{$product->slug}}" required>
                                         <font style="color:#e60000">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="number" name="price" class="form-control form-control-sm" value="{{$product->price}}"  required>
                                        <font style="color:#e60000">
                                         {{($errors->has('price'))?($errors->first('price')):' '}}
                                        </font>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="number" name="discount" class="form-control form-control-sm" id="" value="{{$product->discount}}">
                                    </div>
                                </div><br/>
                                <div class="form-row">
                                    <label for="quantity" class="col-md-3 control-label">Quantity</label>
                                    <div class="col-md-9">
                                        <input  type="number" class="form-control form-control-sm" name="qty" value="{{$product->qty}}" required>
                                        <font style="color:#e60000">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="details" rows="4" class="form-control form-control-sm" required>{{$product->details}}</textarea>
                                        <font style="color:#e60000">
