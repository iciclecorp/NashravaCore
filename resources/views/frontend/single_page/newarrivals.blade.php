@extends('frontend.layouts.master')
 @section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumbs">
                        <a href="index.html">Home</a> <span class="separator">&gt;</span> <span>New Arrivals</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Start Breadcrumb -->
    <!-- Start Banner -->
    <div id="banner-area" style="background: rgba(0, 0, 0, 0) url({{ asset(get_static_option('newarrival_image')) }}) no-repeat scroll center top;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
