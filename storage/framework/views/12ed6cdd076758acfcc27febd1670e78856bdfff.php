        ...
        <div class="col-md-12">
          <table width="100%">
            <tbody>
                 <tr>
                <td>
                  <p>Selling Report (<?php echo e(date('d-m-Y',strtotime($start_date))); ?> to <?php echo e(date('d-m-Y',strtotime($end_date))); ?>)</p>    
                </td>
          ...
          <table id="border"  width="100%" >
                    ...
                    <tbody>
                      <?php
                         $total_sum = '0';
                      ?>
                      <?php $__currentLoopData = $daily_invoice_report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                      <tr>
                        <?php
                             $order_details  =  App\Model\OrderDetail::where('order_id' , $sell->id)->sum('quantity');
                        ?>
                        <td># <?php echo e($key+1); ?></td>
                        <td><?php echo e($sell->order_no); ?></td>
                        <td><?php echo e(date('d-m-Y',strtotime($sell->selling_date))); ?></td>
                         <td style="text-align: center;background-color:orange"><?php echo e($order_details); ?>

                        </td>
                        <td style="text-align: center;background-color:orange"><?php echo e($sell->order_total_amount); ?></td>
                        <?php
...
</html><?php /**PATH /home3/fjxufomy/public_html/nashravaco/resources/views/backend/pdf/daily-selling-report.blade.php ENDPATH**/ ?>