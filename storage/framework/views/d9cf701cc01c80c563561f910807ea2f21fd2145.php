            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="breadcrumbs">
                        <a href="index.html">Home</a> <span class="separator">&gt;</span> <span>Dashboard</span>
                    </div>					   
                </div>
            </div>
        </div>
                ...
                <div class="container pt-1">
                    <div class="tab tab-vertical">
                        <ul class="nav nav-tabs mb-4" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('dashboard')); ?>" style="font-weight: bold">Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a  class="nav-link" href="<?php echo e(route('customer.order.list')); ?>" style="font-weight: bold;">Orders</a>
                            </li>
                            <li class="nav-item">
