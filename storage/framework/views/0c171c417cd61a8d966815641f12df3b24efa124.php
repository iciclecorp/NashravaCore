            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="banner-inner"> 
                        <a class="btn-lucian" href="#"><?php echo e($cat_name->sub_category_name); ?></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="prodcut-toolbar"> 
                    <div class="col-sm-8 col-md-8">
                        ...
                        <form action="<?php echo e(route('sub.category.wise.product', $cat_name->id)); ?>" method="get">
                        <div class="col-sm-8 col-md-8">
                            <div class="toolbar-form">
            ...
            <div class="row"> 
                ...
                <div class="tab-content"> 
                    ...
                    <div id="grid" class="tab-pane" role="tabpanel"> 
                        ...
                        <?php $__currentLoopData = $sub_cat_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
?>
                        ...
                        <div class="prodcuts-pagination"> 
                            ...
                            <?php echo $sub_cat_products->links('frontend.library.pagination.custom'); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\NashravaCore\resources\views/frontend/single_page/sub-category-product-list.blade.php ENDPATH**/ ?>