     ...
     <?php if(Request::is('admin*')): ?>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           <li class="nav-item has-treeview <?php if(Request::is('admin/customer/index') || Request::is('admin/customer/draft/view') || Request::is('admin/local/customer/view') || Request::is('admin/local/customer/due-list') || Request::is('admin/local/customer/edit/invoice/*')): ?>
           menu-open
...
<?php /**PATH /home3/fjxufomy/public_html/nashravaco/resources/views/backend/layout/sidebar_customer.blade.php ENDPATH**/ ?>