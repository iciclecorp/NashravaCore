            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner-inner">
                        <a class="btn-lucian" href="#"><?php echo e($cat_name->category_name); ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="prodcut-toolbar">
                    <form action="<?php echo e(route('category.wise.product', $cat_name->id)); ?>" method="get">
            ...
            <div class="row">
                ...
                <div class="tab-content">
                    ...
                    <div id="grid" class="tab-pane" role="tabpanel">
                        ...
                        <?php $__currentLoopData = $cat_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
?>
                    ...
                    <div class="prodcuts-pagination">
                            ...
                            <?php echo $cat_products->links('frontend.library.pagination.custom'); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\NashravaCore\resources\views/frontend/single_page/category-product-list.blade.php ENDPATH**/ ?>