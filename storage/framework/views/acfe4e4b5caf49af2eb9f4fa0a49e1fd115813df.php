          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3><?php echo e(__('back_blade.view_user_add')); ?>

                  <a class="btn btn-success btn-sm float-right" href="<?php echo e(route('user.index')); ?>"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;<?php echo e(__('back_blade.view_user_list')); ?></a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                  <form method="post"  action="<?php echo e(route('user.store')); ?>" id="myForm">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                          ...
                          <font style="color:red"><?php echo e(($errors->has('password2'))?($errors->first('password2')):' '); ?></font>
                      </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/fjxufomy/public_html/nashravaco/resources/views/backend/user/create.blade.php ENDPATH**/ ?>