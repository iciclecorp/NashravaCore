          ...
          <section class=" content col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3><?php echo e(__('back_blade.view_product_add')); ?>
              ...
              <div class="card-body">
                <form  method="post" action="<?php echo e(route('product.store')); ?>" class="form-horizontal" id="myForm" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                    ...
                    <!-- form start -->
                          <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <select name="product_name" id="product_id" class="form-control form-control-sm select2" required>
                                          <option value="">--Select Product--</option>
                                          <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($purchase->id); ?>"><?php echo e($purchase->product_name); ?></option>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <font style="color:#e60000">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="title" id="title" class="form-control form-control-sm" placeholder="Product Title" required>
                                         <font style="color:#e60000">
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="slug"  class="form-control form-control-sm" placeholder="Slug/Url" required>
                                         <font style="color:#e60000">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="number" name="price" class="form-control form-control-sm" id="" placeholder="Price" value="0" required>
                                        <font style="color:#e60000">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" name="discount" class="form-control form-control-sm" id="" placeholder="Discounted Price">
                                    </div>
                                </div><br/>
                                <div class="form-row">
                                    <label for="quantity" class="col-md-3 control-label">Quantity</label>
                                    <div class="col-md-9">
                                        <input  type="number" class="form-control form-control-sm" name="qty" id="qty" required readonly>
                                        <font style="color:#e60000">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="details" rows="3" class="form-control form-control-sm" required></textarea>
                                        <font style="color:#e60000">
                      ...
                      <div class="form-row">
                        ...
                        <div class='form-group col-md-9'>
                            <select name="color_id[]" id="color_id" class="form-control form-control-sm select2" multiple placeholder="Select Color">
   ...
   $(document).on('change','#category',function(){
    ...
    $(document).on('change','#product_id',function(){
     ...
     console.log( purchase_id);
      $.ajax({
        url:"<?php echo e(route('get-purchase-qty')); ?>",
        dataType:'json', 
        type:"GET",
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/fjxufomy/public_html/nashravaco/resources/views/backend/product/create.blade.php ENDPATH**/ ?>