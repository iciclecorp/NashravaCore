        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form method="get" action="<?php echo e(route('purchase.daily.report.print')); ?>" target="_blank" id="myForm">
                   <div class="row">
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/fjxufomy/public_html/nashravaco/resources/views/backend/purchase/purchase-report.blade.php ENDPATH**/ ?>