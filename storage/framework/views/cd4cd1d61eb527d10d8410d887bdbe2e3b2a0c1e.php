            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" >
                         <form id="login-form" class="form" action="<?php echo e(route('customer.signup.store')); ?>" method="post">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="password" name="confirmation_password" id="confirmation_password" class="form-control" placeholder=" Please Enter Your Confirm Password" required>
                                 <font style="color:red">
                                 <?php echo e(($errors->has('confirmation_password'))?($errors->first('confirmation_password')):' '); ?>
                            ...
                            <div class="form-group">
                                ...
                                <i class="fa fa-user" ></i> Have you account ? <a href="<?php echo e(route('customer.login')); ?>"><span style="font-weight : bold">Login here</span></a>
                            </div>
