...
<!-- Content Wrapper. Contains page content -->
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3><?php echo e(__('back_blade.view_invoice_add')); ?>

                  <a class="btn btn-success btn-sm float-right" href="<?php echo e(route('invoice.index')); ?>"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;<?php echo e(__('back_blade.view_invoice_list')); ?></a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <form id="invoice_form" method="POST">
                  ...
                  <div class="row">
                      <div class="form-group col-md-3">
                          ...
                          <input type="text" name="invoice_no" value="<?php echo e($invoice_no); ?>"  class="form-control form-control-sm" id='invoice_no' readonly style="background-color: #D8FDBA">
                      </div>
                       <div class="form-group col-md-3">
                          <label for="date">Date</label>
                          <input type="text" name="date" value="<?php echo e($selling_date); ?>"  class="form-control form-control-sm datepicker"  id="date" placeholder="MM-DD-YYYY"  readonly>
                      </div>
                      <div class="form-group col-md-3">
              ...
              <form action="<?php echo e(route('invoice.store')); ?>" method="post">
                ...
                <div class="form-row">
                   ...
                   <div class="form-group col-md-4">
                      ...
                      <select name="customer_id" id="customer_id" class="form-control form-control-sm select2">
                        ...
                        <option value="<?php echo e($cus->id); ?>"><?php echo e($cus->customer_name); ?>(<?php echo e($cus->mobile_no); ?>-<?php echo e($cus->address); ?>)</option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-row new_customer" style="display:none">
                 ...
                 <div class="form-group col-md-12">
                    <input type="hidden" name="invoice_no" value="<?php echo e($invoice_no); ?>">
                </div>
                 <div class="form-group col-md-12">
                    <input type="hidden" name="date" value="<?php echo e($selling_date); ?>">
                </div>
 ...
 $(function(){
       ...
       $.ajaxSetup({
        ...
        $.ajax({
          data: data,
          url: "<?php echo e(route('inserts.cart')); ?>",
          method: "POST",
           ...
           console.log(data);
            ...
            $(function(){
             ...
             $('.removeeventmore').click(function(){
                ...
                console.log(id);
                $.ajax({
                url : "<?php echo e(url('delete-cart')); ?>"+'/'+id, 
                method : 'GET', 
                success: function (data) {
                console.log('data');  
                console.log('success');        
...
$(function(){
    $(document).on('change','#product_id',function(){
          ...
          $.ajax({
               url: "<?php echo e(route('check-product-price')); ?>",
               type: "GET",
               data: {product_id:product_id},
               success: function(data){
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/fjxufomy/public_html/nashravaco/resources/views/backend/invoice/create.blade.php ENDPATH**/ ?>