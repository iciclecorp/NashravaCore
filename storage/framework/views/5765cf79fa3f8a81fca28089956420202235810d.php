            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner-inner blog-banner">
                        <a class="btn-lucian" href="#">Shoping Cart</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <!-- <div class="coupon-area">
                        ...
                        <input class="submit-cupon" type="submit" value="Apply Coupon">
                    </div> -->
                    <!-- End Copun -->
                </div>
                <div class="col-md-6">
                    <div class="update-cart-area">
                        <input type="submit" class="lucian-border-btn" value="CONTINUE SHOPPING">
                        <a href="#" class="lucian-border-btn">UPDATE SHOPPING CART</a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="place-section">
                        ...
                        <!-- End Table -->
                        <a href="#" class="lucian-gray-btn">Procced To checkout</a>
                    </div>
                    <!-- End Place Section -->
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/fjxufomy/public_html/nashravaco/resources/views/frontend/cart.blade.php ENDPATH**/ ?>